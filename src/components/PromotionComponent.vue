<template>
  <div class="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 p-5 gap-4 rounded-2xl justify-items-center">
    <div
    ...
    >
      <div
        :class="[
          'flex flex-col mt-5 ml-2 lg:mt-0 lg:ml-0 xl:ml-0 xl:mt-0 z-10',
      ...
      >
        ...
        <ButtonComponenet :text="item.button.text" :bg-color="item.button.bgColor" />
      </div>
      <div
        :class="[
          'absolute xl:top-0 bottom-0 right-0 mt-10 overflow-hidden',
...
import { ref } from 'vue'
import ButtonComponenet from './ButtonComponenet.vue';
